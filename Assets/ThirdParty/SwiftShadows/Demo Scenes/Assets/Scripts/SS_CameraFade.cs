...
public class SS_CameraFade : MonoBehaviour {
    private static SS_CameraFade mInstance;

    private static SS_CameraFade instance {
        get {
            if (mInstance == null) {
                mInstance = FindObjectOfType(typeof (SS_CameraFade)) as SS_CameraFade ??
                            new GameObject("CameraFade").AddComponent<SS_CameraFade>();
            }
